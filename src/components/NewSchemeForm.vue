      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="方案名称" prop="schemeFinallyName">
            <el-input v-model="formData.schemeFinallyName" placeholder="选择或输入方案" filterable default-first-option
              allow-create :style="{ width: '100%' }" @change="changeSchemeName"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8" :offset="4">
          <el-form-item label="所属分组" prop="groupName">
            <el-select v-model="formData.groupName" placeholder="请选择所属分组" filterable allow-create default-first-option
              clearable :style="{ width: '100%' }">
              <el-option v-for="(schemeGroup, index) in configPage.schemeGroups" :key="index"
                :label="schemeGroup.groupName" :value="schemeGroup.groupName"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="8">
          <el-form-item label="模板方案" prop="schemeModelName">
            <el-select v-model="formData.schemeModelName" placeholder="选择模板方案" filterable clearable
              :style="{ width: '100%' }" @change="changeSchemeName">
        ...
        <el-col :span="4" :offset="4">
          <el-form-item label="音节" prop="syllable">
            <el-select v-model="formData.syllable" placeholder="请选择音节" filterable :style="{ width: '100%' }"
              @change="changeSyllable">
              <el-option-group label="声母">
                <el-option v-for="(keyboard, sheng, index) in syllableOptions.sheng" :key="index" :label="sheng"
                  :value="sheng"></el-option>
              </el-option-group>
              <el-option-group label="韵母">
                <el-option v-for="(keyboard, yun, index) in syllableOptions.yun" :key="index" :label="yun" :value="yun">
                </el-option>
              </el-option-group>
              <el-option-group label="零声母">
                <el-option v-for="(keyboard, zero, index) in syllableOptions.zero" :key="index" :label="zero"
                  :value="'zero' + zero"></el-option>
              </el-option-group>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="7" :offset="1">
          <el-form-item label="按键" prop="keyboard">
            <el-select v-model="formData.keyboard" placeholder="请选择按键" filterable default-first-option allow-create
              :style="{ width: '100%' }" :collapse-tags-tooltip="true" collapse-tags @blur="checkKeyboard"
              ref="keyboard">
